...
for POST /api/students/enroll at https://smarttrack-edu-2.preview.emergentagent.com/api
"""
...
class EnrollmentDiagnosticTester:
    def __init__(self):
        self.base_url = "https://smarttrack-edu-2.preview.emergentagent.com/api"
        self.gov_token = None
    ...
    def step7_test_options_preflight(self):
        ...
        url = f"{self.base_url}/students/enroll"
        headers = {
            'Origin': 'https://smarttrack-edu-2.preview.emergentagent.com',
