...
for POST /api/students/enroll at https://teacher-reg-fix.preview.emergentagent.com/api
"""
...
class EnrollmentDiagnosticTester:
    def __init__(self):
        self.base_url = "https://teacher-reg-fix.preview.emergentagent.com/api"
        self.gov_token = None
    ...
    def step7_test_options_preflight(self):
        ...
        url = f"{self.base_url}/students/enroll"
        headers = {
            'Origin': 'https://teacher-reg-fix.preview.emergentagent.com',
