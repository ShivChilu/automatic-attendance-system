...
def test_json_post_to_enroll():
    ...
    url = "https://sidebar-mobile-debug.preview.emergentagent.com/api/students/enroll"
    headers = {
...
def test_other_multipart_endpoint():
    ...
    url = "https://sidebar-mobile-debug.preview.emergentagent.com/api/attendance/mark"
    headers = {
